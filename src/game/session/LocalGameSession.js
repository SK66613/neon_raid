...
import { cloneSerializable, createCommandMessage, createFrameMessage, PROTOCOL_VERSION, SessionResponseType, validateSessionResponses } from './protocol.js';
...
export class LocalGameSession extends GameSession {
  ...
  #accept(responses) {
    for (const response of validateSessionResponses(responses)) {
