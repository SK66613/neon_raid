...
export class GameSimulation {
  ...
  damageBoss(amount = 100) {
    ...
    this.#updateBossPhase(); this.#emit('boss-hit', { damage: amount, hp: b.hp });
  ...
  #bossPattern() { const b=this.state.boss;if(b.phase===1){this.#bossBurst(5,.72,165);if(this.rng.next()<.65)this.#danger(55,30,30,1);b.attackTimer=.82}else if(b.phase===2){this.rng.next()<.5?this.#bossBurst(7,.98,178):this.#bossRadial(11,136);this.#danger(75,46,32,.82);b.attackTimer=.68}else{this.rng.next()<.48?this.#bossRadial(15,146):this.#bossBurst(9,1.22,188);this.#danger(90,54,34,.65);this.#danger(90,54,28,.78);b.attackTimer=.54} }
